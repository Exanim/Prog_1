...
public:
	Person() {}
	Person(string first, string last, int n) {__init__(first, last, n); }

	void __init__(string first, string last, int n){
	...
	void lambda(string first, string last, int n) {}
